...
if(isset($_COOKIE['permission'])){
  $_SESSION['username'] = $_COOKIE['permission'];
}
...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <div class="circle border shadow-drop-center"></div>
    </div>
    <!-- END OF CONTAINER -->
 ...
 <!-- END LOGIN CHECK -->
                    ...
                    <form action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputusername"  name="username" required="required" autofocus>
                        
                      </div>

                      <div class="form-group">
                        <label for="InputPassword1">Password</label>
                        <input type="password" class="form-control" id="InputPassword1" name="password" aria-describedby="passwordHelp" required="required">
                      ...
                      <div class="form-group form-check">
                        ...
                        <label class="form-check-label" >Biarkan saya tetap masuk</label>
                      </div>
                      <button type="submit" class="btn btn-primary btn-md btn-block" name="submit">Masuk</button>
                      <div class="text-center mt-4">
                        <label>Belum punya akun?</label>
                        <a href="registrasi.php" class="text-primary">Buat Akun</a>
                      </div>
                    </form>
